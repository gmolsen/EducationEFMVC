...
namespace EducationEFMVC.Controllers
{
    public class StudentsController : Controller
    {
        ...
        {
			//context.pluralized-model-class.method --- > retrieves all students in database
        ...
        public ActionResult Details(int? id)
        {
			...
			// Find() method pulls from students based on primary key
        ...
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName,SAT,GPA,Phone,Email")] Student student)
        {
            ...
            {
				//makes changes and then updates database
